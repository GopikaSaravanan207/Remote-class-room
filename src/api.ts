...
export const api = {
  ...
  staff: {
    ...
    getCourseResults: async () => fetch(`${API_BASE}/staff/course-results`, { headers: await getHeaders() }).then(res => res.json()),
    getAttemptDetails: async (attemptId: string) => fetch(`${API_BASE}/staff/attempt-details/${attemptId}`, { headers: await getHeaders() }).then(res => res.json()),
  ...
  student: {
    ...
    submitAnswers: async (data: any) => fetch(`${API_BASE}/student/submit-answers`, {
      method: 'POST',
      headers: await getHeaders(),
      body: JSON.stringify(data),
    }).then(res => res.json()),
...
getProgress: async () => fetch(`${API_BASE}/student/progress`, { headers: await getHeaders() }).then(res => res.json()),
    getNotifications: async () => fetch(`${API_BASE}/student/notifications`, { headers: await getHeaders() }).then(res => res.json()),
    markNotificationRead: async (id: number) => fetch(`${API_BASE}/student/notifications/${id}/read`, { method: 'POST', headers: await getHeaders() }).then(res => res.json()),
    markAllNotificationsRead: async () => fetch(`${API_BASE}/student/notifications/read-all`, { method: 'POST', headers: await getHeaders() }).then(res => res.json()),
  }
};
